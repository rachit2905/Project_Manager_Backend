...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public Comment createComment(final Long issueId, final Long userId, final String commentText) {
    ...
    public void deleteComment(final Long commentId, final Long userId) {
        ...
        if (comment.isEmpty()) {
            throw new IllegalArgumentException("Comment not found or you don't have permission to delete it");
        }
